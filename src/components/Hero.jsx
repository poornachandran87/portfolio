...
const Hero = () => {
    const config  = {
        ...
        social: {
            twitter: 'https://twitter.com/poornachandran',
  ...
  return (
      <section id='/' className='flex flex-col md:flex-row justify-center  px-5 py-32 bg-primary' >
          <div className='w-1/2 flex flex-col'>
              ...
              <h1 className=' text-white text-4xl font-hero-font  '>Hi, <br /> I am Poornachandran S
                  <p className='text-2xl'>
                      {config.subtitle}
                  </p>
              </h1>
              <div className='flex py-10'>
                <a href={config.social.twitter}  target='blank' className='pr-5 hover:text-white'><AiOutlineTwitter size={40} /></a>
